...
**Read this before writing any code.** This file and `AGENTS.md` are identical by policy; Claude
lanes read CLAUDE.md, kimi and codex lanes read AGENTS.md. If you edit one, mirror it to the other
in the same commit.
