...
| [MATERIAL BREACH](games/material-breach) | You run the dungeon. Adventurers are an occupational incident, filed with a root-cause analysis and a corrective-action owner. | 208 | **Release gate** — 9-step run 2026-08-18; a save-brick blocker and a phantom notice fix caught and closed in-gate; 205/205. Hotfixed 2026-08-19: the examiner's Q3 finding (a full refund implemented and shipped, but unreachable from any player action) wired to a live Withdraw control on the action bar; 208/208. **Released 2026-08-26**: full gate re-run 2026-08-23 re-certified all step-7 findings fixed; battery 208/208 re-run by the shipping session; live artifact hash-verified; step-9 operator waiver recorded. | [play](https://lerugray.github.io/field-trials/material-breach/) |
...
3,754 tests across the twelve on the shelf; ADVERSARY's 300 keep running in CI while it is
